...
const createUserSchema = z.object({
  ...
  role: z.enum(['ADMIN', 'DIRETOR', 'COMERCIAL', 'TECNICO', 'ORCAMENTO', 'FINANCEIRO', 'PCP', 'PRODUCAO', 'QUALIDADE', 'ALMOXARIFADO', 'RH']),
...
const updateUserSchema = z.object({
  ...
  role: z.enum(['ADMIN', 'DIRETOR', 'COMERCIAL', 'TECNICO', 'ORCAMENTO', 'FINANCEIRO', 'PCP', 'PRODUCAO', 'QUALIDADE', 'ALMOXARIFADO', 'RH']).optional(),
  photo: z.string().optional(),
